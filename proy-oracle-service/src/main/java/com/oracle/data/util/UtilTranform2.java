...
public abstract class UtilTranform2<E> {
	
	public abstract String objectToJson(E e,String format);
	public abstract E JsonToObject(String json);
	public abstract String ObjectToXML(String nameXML, E e) throws JAXBException;
